...
function get_card_by_slug(WP_REST_Request $request) {
...
function registrar_get_card_by_slug() {
    register_rest_route('api', '/cards/(?P<slug>[a-zA-Z0-9-]+)', array(
        'methods' => 'GET',
        'callback' => 'get_card_by_slug',
    ));
}
add_action('rest_api_init', 'registrar_get_card_by_slug');
